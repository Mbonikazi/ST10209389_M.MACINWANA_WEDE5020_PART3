...
- Colors: Change the CSS variables in `:root` in `style.css`
- Font: Modify `--base-font` in `style.css`
- Grid Layout: Adjust `.site-grid` columns for sidebar or main content width
- Background: Change `body { background-color: yellow; }` to your preferred color



this is how I built my part3 5 pages and CSS file
